...
class GA:
    ...
    def crossover_pmx(self, parent1, parent2, program_dict):
        ...
        child1, child2 = {}, {}
        child1['value'] = parent1['value'][:cxpoint1] + parent2['value'][cxpoint1:cxpoint2-1] + parent1['value'][cxpoint2:]
        child2['value'] = parent2['value'][:cxpoint1] + parent1['value'][cxpoint1:cxpoint2-1] + parent2['value'][cxpoint2:]
        child1 = self.mutate(child1, program_dict)
        child2 = self.mutate(child2, program_dict)
